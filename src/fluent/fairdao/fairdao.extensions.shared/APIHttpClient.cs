                ...
                else
                {
                    switch (r.StatusCode)
                    {
                        case System.Net.HttpStatusCode.NotFound:
                            throw new fairdao.extensions.shared.exs.APICodeException(fairdao.extensions.shared.entity.StateCode.请求的资源不存在);

                        default:
                            throw new fairdao.extensions.shared.exs.APICodeException(fairdao.extensions.shared.entity.StateCode.操作失败, "出错：状态码: " + r.StatusCode);
                    }
