...
namespace fairdao.extensions.shared.services
{
    public class NewWordRecorder : INewWordRecorder
    {
        ...
        private fairdao.extensions.shared.services.TransService trans;

        SysHelper helper;
        public NewWordRecorder(fairdao.extensions.shared.services.TransService transService,SysHelper helper)
        {
