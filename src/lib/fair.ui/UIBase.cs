...
namespace fair.ui
{
    public class UIBase : ComponentBase, IAsyncDisposable
    {
        ...
        [Inject]
        protected fair.extensions.shared.localization.GensysLocaler Localer { get; set; }
        ...
        /// </summary>
        [Parameter]
        public fair.extensions.shared.entity.AlertMessage AlertMessage { get; set; }
        ...
        {
            fair.extensions.shared.entity.AlertMessage msg = new AlertMessage();
        ...
        public void Toast(string msg, string level = "")
        {
            if (msg == null) return;
            level = level ?? "";
            JSRuntime.InvokeVoidAsync("fair.ui.Toast", msg, level);
        }
        ...
        {
            JSRuntime.InvokeVoidAsync("fair.ui.Popup", selector, x, y);
        }
        ...
        {
            fair.extensions.shared.entity.AlertMessage msg1 = new AlertMessage();
        ...
        public void AddNotification(fair.extensions.shared.entity.AlertMessage msg)
        {
