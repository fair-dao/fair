...
namespace fair.extensions.shared
{
    ...
    public class SysHelper
    {
        ...
        public static List<fair.extensions.shared.Extender> Extenders;
        ...
        /// 客户端配置 
        /// </summary>
        public fair.extensions.shared.entity.ClientConfig ClientConfig { get; set; }


        public SysHelper(IDataStore dataStore, fair.extensions.shared.entity.Env env)
        {
        ...
        public string GetFace(string face)
        {
            ...
            return $"/_content/fair.extensions.wallet/images.chains/{face??"no"}.svg";
        ...
        public async Task SetClientConfig(fair.extensions.shared.entity.ClientConfig config)
        {
        ...
        public async Task SaveLocalData()
        {
            ...
            await dataStore.SetConfig("cultures", new fair.extensions.shared.entity.IndexedConfigData<List<Culture>> { Id = "cultures", Entity = LocalData.Cultures });
            string langId = $"{NAME_LOCALDATA_STOREID}-{LocalData.LangWords.Code}";
            await dataStore.SetConfig(langId, new fair.extensions.shared.entity.IndexedConfigData<string> { Id = langId, Entity = lan });
        ...
        public async Task LoadLocalData()
        {
            ...
            fair.extensions.shared.entity.IndexedConfigData<List<Culture>> cultures = await dataStore.GetConfig<fair.extensions.shared.entity.IndexedConfigData<List<Culture>>>($"cultures");
            fair.extensions.shared.entity.IndexedConfigData<string> langInfo = await dataStore.GetConfig<fair.extensions.shared.entity.IndexedConfigData<string>>($"{NAME_LOCALDATA_STOREID}-{lang}");
        ...
        public async Task ChangeLang(fair.extensions.shared.services.TransService trans, GensysLocaler localer, string lang, bool must = false)
        {
