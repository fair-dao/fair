...
{
    public class ComBase : fair.ui.UIBase
    {
    ...
    [Inject]
        ...
        [Inject]
        protected fair.extensions.shared.SysHelper sysHelper { get; set; }
        ...
        public override void ThrowException(object data, Exception e)
        {
            ...
            if (e is fair.extensions.shared.exs.NoPowerException) //无权访问
            {
            ...
            //if (e is fair.extensions.shared.exs.NoLoginException)
            //{
            ...
            //}
            var apiException = e as fair.extensions.shared.exs.APICodeException;
        ...
        public void WraperException(Func<Result> funResult)
        {
            ...
            try
            {
                ...
                if (result.state != Result.STATE_OK)
                {
                    ...
                    {
                        throw new fair.extensions.shared.exs.NoLoginException();
                    }
                    throw new fair.extensions.shared.exs.CallErrorException(result.msg);
                }
            }
            catch (fair.extensions.shared.exs.ProcessedException e) //无权访问
            {
